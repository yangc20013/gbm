...
CREATE TABLE `menu` (
  ...
  `parent_id` bigint(10) unsigned NOT NULL DEFAULT '0' COMMENT '父级菜单 ID， 为 0 表示顶级菜单',
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'admin', '123456', 'ee@1.com', '$2a$10$e/xlEUPwuMCyDeVOknng8uCs9Bdzh1Af91GHCn.DwEVXLrEWtRMqK', '0', '1', '', '1', '', 'admin', '', '2017-12-19 15:26:56', '2018-03-09 14:45:45');
COMMIT;
